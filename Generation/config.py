...
parser.add_argument('--nz', type=int, default=2560, help='dimensional of noise')
...
parser.add_argument('--snapshot', type=int, default=1, help='how many epochs to save model')
parser.add_argument('--choice', default='mwp', help='choice class')
